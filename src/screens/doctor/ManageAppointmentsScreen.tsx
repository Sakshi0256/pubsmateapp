...
const styles = StyleSheet.create({
  ...
  header: { fontSize: 20, fontWeight: '800', color: '#1A1A1A', letterSpacing: -0.5 },
  ...
  tabsContainer: { flexDirection: 'row', marginBottom: 14, gap:4 },
  tab: { flexDirection: 'row', alignItems: 'center', paddingHorizontal: 8, paddingVertical: 8, borderRadius: 20, backgroundColor: '#F5F5F5', borderWidth: 1, borderColor: 'transparent' },
